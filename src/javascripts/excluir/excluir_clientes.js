...
function fetchDeletar(body) {
    ...
    return fetch('http://localhost:3000/excluirCliente', requestOptions)
    .then(T => T.json())
}
    ...
    fetchDeletar({
        ...
        .then(resultado => {
            ...
            if (resultado.status === "SUCCESS") {
                showStatusMessage("Cliente excluído!", false);
            } else {
                showStatusMessage("Erro ao excluir cliente: " + message, true);
